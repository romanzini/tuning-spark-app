...
docker exec -it spark-master /opt/bitnami/spark/bin/spark-submit \
  ...
  --deploy-mode client \
  /opt/bitnami/spark/jobs/elt-rides-fhvhv-py-cookie.py
"""
...
def main():
    spark = init_spark_session("elt-rides-fhvhv-py-cookie")
    ...
    # TODO write in delta
    df_total_trip_time.write.format("delta").mode("overwrite").partitionBy("PU_Borough").save("./storage/rides/delta/total_trip_time")
    df_hvfhs_license_num.write.format("delta").mode("overwrite").partitionBy("hvfhs_license_num").save("./storage/rides/delta/hvfhs_license_num")
