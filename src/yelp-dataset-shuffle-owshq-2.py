"""
Spark App: yelp-dataset-shuffle-owshq-2
Author: Rodrigo Romanzini

docker exec -it spark-master /opt/bitnami/spark/bin/spark-submit \
  --master spark://spark-master:7077 \
  --deploy-mode client \
  /opt/bitnami/spark/jobs/yelp-dataset-shuffle-owshq-2.py
"""
...
def main():
    ...
    spark = init_spark_session("yelp-dataset-shuffle-owshq-2")
    ...
    df_join_users = df_join_reviews_business.alias("rb").join(df_users.alias("u"), col("rb.user_id") == col("u.user_id"))
    df_join_users.show()
    df_join_users.explain()
    ...
    metrics = "./metrics/yelp-dataset-shuffle-owshq-2/"
