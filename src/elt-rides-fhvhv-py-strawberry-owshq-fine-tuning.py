...
"""
PySpark: elt-rides-fhvhv-py-strawberry-owshq-fine-tuning
...
docker exec -it spark-master /opt/bitnami/spark/bin/spark-submit \
  ...
  --deploy-mode client \
  /opt/bitnami/spark/jobs/elt-rides-fhvhv-py-strawberry-owshq-fine-tuning.py
"""
...
def main():
    ...
    spark = init_spark_session("elt-rides-fhvhv-py-strawberry-owshq-fine-tuning")
    ...
    df_rides = spark.sql("""
        SELECT /*+ BROADCASTJOIN(zones_pu) */ hvfhs_license_num,
    ...
    metrics = "s3a://warehouse/metrics/elt-rides-fhvhv-py-strawberry-owshq-fine-tuning/"
